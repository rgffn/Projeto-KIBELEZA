...
<body><!-- CORPO -->
	...
	<div class="faixaServico wow fadeInUp">
		<section class="site corpoServico"><!-- SERVIÇO -->
			...
			<section>			
				<article>
					<img src="IMG/servico1.png" alt="SERVIÇO">
					<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
					Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
					</p>
				</article>
				<article>
					<img src="IMG/servico2.png" alt="SERVIÇO">
					<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
					Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
					</p>
				</article>
				<article>
					<img src="IMG/servico3.png" alt="SERVIÇO">
				...
				<article>
					<img src="IMG/servico4.png" alt="SERVIÇO">
					<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy textm has</p>
				</article>			
            </section>
            <section>			
