...
$dados;
        ...
        if($conexao){
            ...
            $query = $conexao->prepare("UPDATE cliente SET nomeCli='".$nome."',emailCli='".$email."',senhaCli='".$senha."',statusCli='".$status."',dataCadCli='".$dataCad."',fotoCli='".$foto."' WHERE idCliente = '".$Codigo."'");
            $query->execute();
